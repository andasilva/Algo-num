...
<body>
  ...
  <footer style="margin-top:100px; border-top:2px solid black; ">
    ...
    <br>
    <h4>Conclusion et perspective </h4>
    L'application développé permet de convertir un Float en binaire et inversement. Cependant il n'y a pas de vérification de saisie qui permettrais d'avertir l'utilisateur des éventuelles erreurs de saisie. En ce qui concerne l'addition, elle se fait uniquement sur 32 bits avec des nombres positifs. Une amélioration de l'addition pourrait être envisagée afin de permettre à l'utilisateur de choisir sur combien de bits il veut additionner. En l’état actuel il n’est pas possible d’additionner des nombres négatifs, ce qui est à corriger.<br>
    Pour pousser le projet plus loin, une idée serait d’implémenter d’autres opérations mathématiques.
